...
class Partner {
  ...
  bool match(String txt) {
    return StringUtils.removerAcentos(companyName.toLowerCase())
        .contains(StringUtils.removerAcentos(txt.toLowerCase()));
  }
  ...
  Partner.fromJson(Map<String, dynamic> json) {
    ...
    analyticsView = json['analyticsView'] ?? 0;
    analyticsCall = json['analyticsCall'] ?? 0;
    analyticsEmail = json['analyticsEmail'] ?? 0;
    analyticsRequest = json['analyticsRequest'] ?? 0;
